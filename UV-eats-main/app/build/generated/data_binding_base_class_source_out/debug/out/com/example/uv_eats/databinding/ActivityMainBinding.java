...
public abstract class ActivityMainBinding extends ViewDataBinding {
  ...
  protected ActivityMainBinding(Object _bindingComponent, View _root, int _localFieldCount,
      Button ButtonLogin, Button ButtonRecoverPassword, Button ButtonSignIn, ImageView Logo,
      TextView Password, EditText TextPassword, EditText TextUser, TextView User,
      LinearLayout linear) {
    super(_bindingComponent, _root, _localFieldCount);
    this.ButtonLogin = ButtonLogin;
    this.ButtonRecoverPassword = ButtonRecoverPassword;
